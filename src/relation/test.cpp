...
void CheckPhase(vector<vector<uint32_t>> outputs, vector<bool> eqtags,
                ENCRYPTO::PsiAnalyticsContext &context) {
...
void testsharedjoinwithtags(ENCRYPTO::PsiAnalyticsContext config) {
  ...
  if (config.role == SERVER) {
    Aweights = {{1, 11, 111}, {2, 22, 222}, {3, 33, 333}, {4, 44, 444},
...
int main(int argc, char **argv) {
  ...
  Atuples = {{1, 11, 2}, {2, 22, 2}, {3, 33, 1}, {4, 44, 7},
             {5, 55, 9}, {6, 66, 3}, {7, 77, 1}, {8, 88, 1}};
